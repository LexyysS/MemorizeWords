 ...
 */var pc;function Xf(){if(pc)return X;pc=1;var i=Symbol.for("react.element"),s=Symbol.for("react.portal"),l=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),m=Symbol.for("react.provider"),b=Symbol.for("react.context"),S=Symbol.for("react.forward_ref"),_=Symbol.for("react.suspense"),E=Symbol.for("react.memo"),R=Symbol.for("react.lazy"),I=Symbol.iterator;function j(g){return g===null||typeof g!="object"?null:(g=I&&g[I]||g["@@iterator"],typeof g=="function"?g:null)}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,w={};function L(g,P,Y){this.props=g,this.context=P,this.refs=w,this.updater=Y||M}L.prototype.isReactComponent={},L.prototype.setState=function(g,P){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,g,P,"setState")},L.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function Q(){}Q.prototype=L.prototype;function se(g,P,Y){this.props=g,this.context=P,this.refs=w,this.updater=Y||M}var ae=se.prototype=new Q;ae.constructor=se,C(ae,L.prototype),ae.isPureReactComponent=!0;var de=Array.isArray,we=Object.prototype.hasOwnProperty,he={current:null},ve={key:!0,ref:!0,__self:!0,__source:!0};function ze(g,P,Y){var Z,re={},oe=null,fe=null;if(P!=null)for(Z in P.ref!==void 0&&(fe=P.ref),P.key!==void 0&&(oe=""+P.key),P)we.call(P,Z)&&!ve.hasOwnProperty(Z)&&(re[Z]=P[Z]);var ue=arguments.length-2;if(ue===1)re.children=Y;else if(1<ue){for(var ye=Array(ue),nn=0;nn<ue;nn++)ye[nn]=arguments[nn+2];re.children=ye}if(g&&g.defaultProps)for(Z in ue=g.defaultProps,ue)re[Z]===void 0&&(re[Z]=ue[Z]);return{$$typeof:i,type:g,key:oe,ref:fe,props:re,_owner:he.current}}function _e(g,P){return{$$typeof:i,type:g.type,key:P,ref:g.ref,props:g.props,_owner:g._owner}}function mn(g){return typeof g=="object"&&g!==null&&g.$$typeof===i}function zn(g){var P={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(Y){return P[Y]})}var sn=/\/+/g;function te(g,P){return typeof g=="object"&&g!==null&&g.key!=null?zn(""+g.key):P.toString(36)}function Ce(g,P,Y,Z,re){var oe=typeof g;(oe==="undefined"||oe==="boolean")&&(g=null);var fe=!1;if(g===null)fe=!0;else switch(oe){case"string":case"number":fe=!0;break;case"object":switch(g.$$typeof){case i:case s:fe=!0}}if(fe)return fe=g,re=re(fe),g=Z===""?"."+te(fe,0):Z,de(re)?(Y="",g!=null&&(Y=g.replace(sn,"$&/")+"/"),Ce(re,P,Y,"",function(nn){return nn})):re!=null&&(mn(re)&&(re=_e(re,Y+(!re.key||fe&&fe.key===re.key?"":(""+re.key).replace(sn,"$&/")+"/")+g)),P.push(re)),1;if(fe=0,Z=Z===""?".":Z+":",de(g))for(var ue=0;ue<g.length;ue++){oe=g[ue];var ye=Z+te(oe,ue);fe+=Ce(oe,P,Y,ye,re)}else if(ye=j(g),typeof ye=="function")for(g=ye.call(g),ue=0;!(oe=g.next()).done;)oe=oe.value,ye=Z+te(oe,ue++),fe+=Ce(oe,P,Y,ye,re);else if(oe==="object")throw P=String(g),Error("Objects are not valid as a React child (found: "+(P==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":P)+"). If you meant to render a collection of children, use an array instead.");return fe}function Ge(g,P,Y){if(g==null)return g;var Z=[],re=0;return Ce(g,Z,"","",function(oe){return P.call(Y,oe,re++)}),Z}function Re(g){if(g._status===-1){var P=g._result;P=P(),P.then(function(Y){(g._status===0||g._status===-1)&&(g._status=1,g._result=Y)},function(Y){(g._status===0||g._status===-1)&&(g._status=2,g._result=Y)}),g._status===-1&&(g._status=0,g._result=P)}if(g._status===1)return g._result.default;throw g._result}var ke={current:null},D={transition:null},G={ReactCurrentDispatcher:ke,ReactCurrentBatchConfig:D,ReactCurrentOwner:he};function U(){throw Error("act(...) is not supported in production builds of React.")}return X.Children={map:Ge,forEach:function(g,P,Y){Ge(g,function(){P.apply(this,arguments)},Y)},count:function(g){var P=0;return Ge(g,function(){P++}),P},toArray:function(g){return Ge(g,function(P){return P})||[]},only:function(g){if(!mn(g))throw Error("React.Children.only expected to receive a single React element child.");return g}},X.Component=L,X.Fragment=l,X.Profiler=f,X.PureComponent=se,X.StrictMode=c,X.Suspense=_,X.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=G,X.act=U,X.cloneElement=function(g,P,Y){if(g==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+g+".");var Z=C({},g.props),re=g.key,oe=g.ref,fe=g._owner;if(P!=null){if(P.ref!==void 0&&(oe=P.ref,fe=he.current),P.key!==void 0&&(re=""+P.key),g.type&&g.type.defaultProps)var ue=g.type.defaultProps;for(ye in P)we.call(P,ye)&&!ve.hasOwnProperty(ye)&&(Z[ye]=P[ye]===void 0&&ue!==void 0?ue[ye]:P[ye])}var ye=arguments.length-2;if(ye===1)Z.children=Y;else if(1<ye){ue=Array(ye);for(var nn=0;nn<ye;nn++)ue[nn]=arguments[nn+2];Z.children=ue}return{$$typeof:i,type:g.type,key:re,ref:oe,props:Z,_owner:fe}},X.createContext=function(g){return g={$$typeof:b,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},g.Provider={$$typeof:m,_context:g},g.Consumer=g},X.createElement=ze,X.createFactory=function(g){var P=ze.bind(null,g);return P.type=g,P},X.createRef=function(){return{current:null}},X.forwardRef=function(g){return{$$typeof:S,render:g}},X.isValidElement=mn,X.lazy=function(g){return{$$typeof:R,_payload:{_status:-1,_result:g},_init:Re}},X.memo=function(g,P){return{$$typeof:E,type:g,compare:P===void 0?null:P}},X.startTransition=function(g){var P=D.transition;D.transition={};try{g()}finally{D.transition=P}},X.unstable_act=U,X.useCallback=function(g,P){return ke.current.useCallback(g,P)},X.useContext=function(g){return ke.current.useContext(g)},X.useDebugValue=function(){},X.useDeferredValue=function(g){return ke.current.useDeferredValue(g)},X.useEffect=function(g,P){return ke.current.useEffect(g,P)},X.useId=function(){return ke.current.useId()},X.useImperativeHandle=function(g,P,Y){return ke.current.useImperativeHandle(g,P,Y)},X.useInsertionEffect=function(g,P){return ke.current.useInsertionEffect(g,P)},X.useLayoutEffect=function(g,P){return ke.current.useLayoutEffect(g,P)},X.useMemo=function(g,P){return ke.current.useMemo(g,P)},X.useReducer=function(g,P,Y){return ke.current.useReducer(g,P,Y)},X.useRef=function(g){return ke.current.useRef(g)},X.useState=function(g){return ke.current.useState(g)},X.useSyncExternalStore=function(g,P,Y){return ke.current.useSyncExternalStore(g,P,Y)},X.useTransition=function(){return ke.current.useTransition()},X.version="18.3.1",X}var hc;function vl(){return hc||(hc=1,dl.exports=Xf()),dl.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var vc;function ep(){return vc||(vc=1,function(i){function s(D,G){var U=D.length;D.push(G);e:for(;0<U;){var g=U-1>>>1,P=D[g];if(0<f(P,G))D[g]=G,D[U]=P,U=g;else break e}}function l(D){return D.length===0?null:D[0]}function c(D){if(D.length===0)return null;var G=D[0],U=D.pop();if(U!==G){D[0]=U;e:for(var g=0,P=D.length,Y=P>>>1;g<Y;){var Z=2*(g+1)-1,re=D[Z],oe=Z+1,fe=D[oe];if(0>f(re,U))oe<P&&0>f(fe,re)?(D[g]=fe,D[oe]=U,g=oe):(D[g]=re,D[Z]=U,g=Z);else if(oe<P&&0>f(fe,U))D[g]=fe,D[oe]=U,g=oe;else break e}}return G}function f(D,G){var U=D.sortIndex-G.sortIndex;return U!==0?U:D.id-G.id}if(typeof performance=="object"&&typeof performance.now=="function"){var m=performance;i.unstable_now=function(){return m.now()}}else{var b=Date,S=b.now();i.unstable_now=function(){return b.now()-S}}var _=[],E=[],R=1,I=null,j=3,M=!1,C=!1,w=!1,L=typeof setTimeout=="function"?setTimeout:null,Q=typeof clearTimeout=="function"?clearTimeout:null,se=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ae(D){for(var G=l(E);G!==null;){if(G.callback===null)c(E);else if(G.startTime<=D)c(E),G.sortIndex=G.expirationTime,s(_,G);else break;G=l(E)}}function de(D){if(w=!1,ae(D),!C)if(l(_)!==null)C=!0,Re(we);else{var G=l(E);G!==null&&ke(de,G.startTime-D)}}function we(D,G){C=!1,w&&(w=!1,Q(ze),ze=-1),M=!0;var U=j;try{for(ae(G),I=l(_);I!==null&&(!(I.expirationTime>G)||D&&!zn());){var g=I.callback;if(typeof g=="function"){I.callback=null,j=I.priorityLevel;var P=g(I.expirationTime<=G);G=i.unstable_now(),typeof P=="function"?I.callback=P:I===l(_)&&c(_),ae(G)}else c(_);I=l(_)}if(I!==null)var Y=!0;else{var Z=l(E);Z!==null&&ke(de,Z.startTime-G),Y=!1}return Y}finally{I=null,j=U,M=!1}}var he=!1,ve=null,ze=-1,_e=5,mn=-1;function zn(){return!(i.unstable_now()-mn<_e)}function sn(){if(ve!==null){var D=i.unstable_now();mn=D;var G=!0;try{G=ve(!0,D)}finally{G?te():(he=!1,ve=null)}}else he=!1}var te;if(typeof se=="function")te=function(){se(sn)};else if(typeof MessageChannel<"u"){var Ce=new MessageChannel,Ge=Ce.port2;Ce.port1.onmessage=sn,te=function(){Ge.postMessage(null)}}else te=function(){L(sn,0)};function Re(D){ve=D,he||(he=!0,te())}function ke(D,G){ze=L(function(){D(i.unstable_now())},G)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(D){D.callback=null},i.unstable_continueExecution=function(){C||M||(C=!0,Re(we))},i.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):_e=0<D?Math.floor(1e3/D):5},i.unstable_getCurrentPriorityLevel=function(){return j},i.unstable_getFirstCallbackNode=function(){return l(_)},i.unstable_next=function(D){switch(j){case 1:case 2:case 3:var G=3;break;default:G=j}var U=j;j=G;try{return D()}finally{j=U}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(D,G){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var U=j;j=D;try{return G()}finally{j=U}},i.unstable_scheduleCallback=function(D,G,U){var g=i.unstable_now();switch(typeof U=="object"&&U!==null?(U=U.delay,U=typeof U=="number"&&0<U?g+U:g):U=g,D){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=U+P,D={id:R++,callback:G,priorityLevel:D,startTime:U,expirationTime:P,sortIndex:-1},U>g?(D.sortIndex=U,s(E,D),l(_)===null&&D===l(E)&&(w?(Q(ze),ze=-1):w=!0,ke(de,U-g))):(D.sortIndex=P,s(_,D),C||M||(C=!0,Re(we))),D},i.unstable_shouldYield=zn,i.unstable_wrapCallback=function(D){var G=j;return function(){var U=j;j=G;try{return D.apply(this,arguments)}finally{j=U}}}}(hl)),hl}var yc;function np(){return yc||(yc=1,pl.exports=ep()),pl.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en extends Error{constructor(s){super(`[GoogleGenerativeAI Error]: ${s}`)}}class Qt extends en{constructor(s,l){super(s),this.response=l}}class Wc extends en{constructor(s,l,c,f){super(s),this.status=l,this.statusText=c,this.errorDetails=f}}class st extends en{}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ac=["text","inlineData","functionCall","functionResponse","executableCode","codeExecutionResult"],Gp={user:["text","inlineData"],function:["functionResponse"],model:["text","functionCall","executableCode","codeExecutionResult"],system:["text"]};function Kp(i){let s=!1;for(const l of i){const{role:c,parts:f}=l;if(!s&&c!=="user")throw new en(`First content should be with role 'user', got ${c}`);if(!_c.includes(c))throw new en(`Each item should include role field. Got ${c} but valid roles are: ${JSON.stringify(_c)}`);if(!Array.isArray(f))throw new en("Content should have 'parts' property with an array of Parts");if(f.length===0)throw new en("Each Content should have at least one part");const m={text:0,inlineData:0,functionCall:0,functionResponse:0,fileData:0,executableCode:0,codeExecutionResult:0};for(const S of f)for(const _ of Ac)_ in S&&(m[_]+=1);const b=Gp[c];for(const S of Ac)if(!b.includes(S)&&m[S]>0)throw new en(`Content with role '${c}' can't contain '${S}' part`);s=!0}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`;return(await l.generateContent(c)).response.text()}function De(i,s){s===void 0&&(s={});var l=s.insertAt;if(i&&typeof document<"u"){var c=document.head||document.getElementsByTagName("head")[0],f=document.createElement("style");f.type="text/css",l==="top"&&c.firstChild?c.insertBefore(f,c.firstChild):c.appendChild(f),f.styleSheet?f.styleSheet.cssText=i:f.appendChild(document.createTextNode(i))}}De(`.react-loading-indicator-normalize,
...
}`);$(Un).toRgb();Array.from({length:4},function(i,s){return"--atom-phase".concat(s+1,"-rgb")});De(`.commet-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--commet-phase".concat(s+1,"-color")});De(`.OP-annulus-rli-bounding-box {
...
}`);var ui=Array.from({length:4},function(i,s){return"--OP-annulus-phase".concat(s+1,"-color")}),gh=function(i){var s,l=Vr(i==null?void 0:i.style,i==null?void 0:i.size),c=l.styles,f=l.fontSize,m=i==null?void 0:i.easing,b=Wr(i==null?void 0:i.speedPlus,"1.5s").animationPeriod,S=function(E){var R={},I=ui.length;if(E instanceof Array){for(var j=Kr(E,I),M=0;M<j.length&&!(M>=4);M++)R[ui[M]]=j[M];return R}try{if(typeof E!="string")throw new Error("Color String expected");for(var C=0;C<I;C++)R[ui[C]]=E}catch(w){for(w instanceof Error?console.warn("[".concat(w.message,']: Received "').concat(typeof E,'" instead with value, ').concat(JSON.stringify(E))):console.warn("".concat(JSON.stringify(E),' received in <OrbitProgress variant="disc" /> indicator cannot be processed. Using default instead!')),C=0;C<I;C++)R[ui[C]]=Un}return R}((s=i==null?void 0:i.color)!==null&&s!==void 0?s:""),_=i!=null&&i.dense?4.3:2.9;return le.createElement("span",{className:"rli-d-i-b OP-annulus-rli-bounding-box",style:ee(ee(ee(ee(ee({},f&&{fontSize:f}),b&&{"--rli-animation-duration":b}),m&&{"--rli-animation-function":m}),S),c),role:"status","aria-live":"polite","aria-label":"Loading"},le.createElement("span",{className:"rli-d-i-b OP-annulus-indicator"},le.createElement("svg",{className:"whirl",viewBox:"25 25 50 50"},le.createElement("circle",{className:"path",cx:"50",cy:"50",r:"20",fill:"none",strokeWidth:_,strokeMiterlimit:"10"})),le.createElement(Gr,{className:"OP-annulus-text",text:i==null?void 0:i.text,textColor:i==null?void 0:i.textColor})))};function ml(i){return i&&i.Math===Math&&i}De(`.OP-dotted-rli-bounding-box {
...
}`);var di=Array.from({length:4},function(i,s){return"--OP-spokes-phase".concat(s+1,"-color")}),yh=function(i){var s,l=Vr(i==null?void 0:i.style,i==null?void 0:i.size),c=l.styles,f=l.fontSize,m=i==null?void 0:i.easing,b=Wr(i==null?void 0:i.speedPlus,"1.2s").animationPeriod,S=function(E){var R={},I=di.length;if(E instanceof Array){for(var j=Kr(E,I),M=0;M<j.length&&!(M>=4);M++)R[di[M]]=j[M];return R}try{if(typeof E!="string")throw new Error("Color String expected");for(var C=0;C<I;C++)R[di[C]]=E}catch(w){for(w instanceof Error?console.warn("[".concat(w.message,']: Received "').concat(typeof E,'" instead with value, ').concat(JSON.stringify(E))):console.warn("".concat(JSON.stringify(E),' received in <OrbitProgress variant="spokes" /> indicator cannot be processed. Using default instead!')),C=0;C<I;C++)R[di[C]]=Un}return R}((s=i==null?void 0:i.color)!==null&&s!==void 0?s:""),_=i!=null&&i.dense?16:12;return le.createElement("span",{className:"rli-d-i-b OP-spokes-rli-bounding-box",style:ee(ee(ee(ee(ee({},f&&{fontSize:f}),b&&{"--rli-animation-duration":b}),m&&{"--rli-animation-function":m}),S),c),role:"status","aria-live":"polite","aria-label":"Loading"},le.createElement("span",{className:"rli-d-i-b OP-spokes-indicator"},Array.from({length:_},function(E,R){return le.createElement("span",{key:Jc(),className:"rli-d-i-b spoke",style:bh(R,_,b)})})),le.createElement(Gr,{text:i==null?void 0:i.text,textColor:i==null?void 0:i.textColor}))};function bh(i,s,l){if(s===16){var c=s-i,f=Number.parseFloat(l)/s;return{transform:"rotate(".concat(360*i/s,"deg) translate(-50%, ").concat("-1.56em",")"),animationDelay:"".concat((c-1)*f*-1,"s")}}}De(`.OP-annulus-dual-sectors-rli-bounding-box {
...
}`);var fi=Array.from({length:4},function(i,s){return"--OP-annulus-dual-sectors-phase".concat(s+1,"-color")}),xh=function(i){var s,l=Vr(i==null?void 0:i.style,i==null?void 0:i.size),c=l.styles,f=l.fontSize,m=i==null?void 0:i.easing,b=Wr(i==null?void 0:i.speedPlus,"1.2s").animationPeriod,S=function(E){var R={},I=fi.length;if(E instanceof Array){for(var j=Kr(E,I),M=0;M<j.length&&!(M>=4);M++)R[fi[M]]=j[M];return R}try{if(typeof E!="string")throw new Error("Color String expected");for(var C=0;C<I;C++)R[fi[C]]=E}catch(w){for(w instanceof Error?console.warn("[".concat(w.message,']: Received "').concat(typeof E,'" with value, ').concat(JSON.stringify(E))):console.warn("".concat(JSON.stringify(E),' received in <OrbitProgress variant="annulus-splits" /> indicator cannot be processed. Using default instead!')),C=0;C<I;C++)R[fi[C]]=Un}return R}((s=i==null?void 0:i.color)!==null&&s!==void 0?s:""),_=i.dense?"0.45em":"";return le.createElement("span",{className:"rli-d-i-b OP-annulus-dual-sectors-rli-bounding-box",style:ee(ee(ee(ee(ee({},f&&{fontSize:f}),b&&{"--rli-animation-duration":b}),m&&{"--rli-animation-function":m}),S),c),role:"status","aria-live":"polite","aria-label":"Loading"},le.createElement("span",{className:"rli-d-i-b OP-annulus-dual-sectors-indicator"},le.createElement("span",{className:"rli-d-i-b annulus-sectors",style:ee({},_&&{borderWidth:_})}),le.createElement(Gr,{className:"OP-annulus-dual-sectors-text",text:i==null?void 0:i.text,textColor:i==null?void 0:i.textColor})))};De(`.OP-annulus-sector-track-rli-bounding-box {
...
}`);var Ir=Array.from({length:4},function(i,s){return["--OP-annulus-track-phase".concat(s+1,"-color"),"--OP-annulus-sector-phase".concat(s+1,"-color")]}),pi=function(i){return i===void 0&&(i=1),.25*i},wh=function(i){var s,l=Vr(i==null?void 0:i.style,i==null?void 0:i.size),c=l.styles,f=l.fontSize,m=i==null?void 0:i.easing,b=Wr(i==null?void 0:i.speedPlus,"1s").animationPeriod,S=function(E){var R={},I=Ir.length;if(E instanceof Array){for(var j=Kr(E,I),M=0;M<j.length&&!(M>=4);M++){var C=Ir[M];try{if(!(Q=$(j[M])).isValid())throw new Error("Invalid Color: ".concat(Q.getOriginalInput()));var w=Q.setAlpha(pi(Q.getAlpha())).toRgbString(),L=j[M];R[C[0]]=w,R[C[1]]=L}catch{L=Un,w=(Q=$(Un)).setAlpha(pi(Q.getAlpha())).toRgbString(),R[C[0]]=w,R[C[1]]=L}}return R}try{var Q=$(E);if(typeof E!="string")throw new Error("Color String expected");if(!Q.isValid())throw new Error("Invalid Color: ".concat(Q.getOriginalInput()));L=E,w=Q.setAlpha(pi(Q.getAlpha())).toRgbString();for(var se=0;se<I;se++)R[(C=Ir[se])[0]]=w,R[C[1]]=L}catch(ae){for(ae instanceof Error?console.warn("[".concat(ae.message,']: Received "').concat(typeof E,'" with value, ').concat(JSON.stringify(E))):console.warn("".concat(JSON.stringify(E),' received in <OrbitProgress variant="annulus-track" /> indicator cannot be processed. Using default instead!')),L=Un,w=(Q=$(Un)).setAlpha(pi(Q.getAlpha())).toRgbString(),se=0;se<Ir.length;se++)R[(C=Ir[se])[0]]=w,R[C[1]]=L}return R}((s=i==null?void 0:i.color)!==null&&s!==void 0?s:""),_=i.dense?"0.45em":"";return le.createElement("span",{className:"rli-d-i-b OP-annulus-sector-track-rli-bounding-box",style:ee(ee(ee(ee(ee({},f&&{fontSize:f}),b&&{"--rli-animation-duration":b}),m&&{"--rli-animation-function":m}),S),c),role:"status","aria-live":"polite","aria-label":"Loading"},le.createElement("span",{className:"rli-d-i-b OP-annulus-sector-track-indicator"},le.createElement("span",{className:"rli-d-i-b annulus-track-ring",style:ee({},_&&{borderWidth:_})}),le.createElement(Gr,{className:"OP-annulus-sector-text",text:i==null?void 0:i.text,textColor:i==null?void 0:i.textColor})))},Zc=function(i){var s=Object(i).variant,l=s===void 0?"disc":s;return l==="dotted"?le.createElement(vh,ee({},i)):l==="spokes"?le.createElement(yh,ee({},i)):l==="disc"?le.createElement(gh,ee({},i)):l==="split-disc"?le.createElement(xh,ee({},i)):l==="track-disc"?le.createElement(wh,ee({},i)):null};De(`.foursquare-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--four-square-phase".concat(s+1,"-color")});De(`.mosaic-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--mosaic-phase".concat(s+1,"-color")});De(`.riple-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--riple-phase".concat(s+1,"-color")});De(`.pulsate-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--TD-pulsate-phase".concat(s+1,"-color")});De(`.brick-stack-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--TD-brick-stack-phase".concat(s+1,"-color")});De(`.bob-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--TD-bob-phase".concat(s+1,"-color")});De(`.bounce-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--TD-bounce-phase".concat(s+1,"-color")});De(`.blink-blur-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--shape-phase".concat(s+1,"-color")});De(`.trophy-spin-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--trophySpin-phase".concat(s+1,"-color")});De(`.slab-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--slab-phase".concat(s+1,"-color")});De(`.lifeline-rli-bounding-box {
...
}`);Array.from({length:4},function(i,s){return"--life-line-phase".concat(s+1,"-color")});const kh=()=>{const{selectedWord:i,closeMoreDetails:s}=$r(),[l,c]=J.useState(null),[f,m]=J.useState(!1);return J.useEffect(()=>{console.log(i),(async()=>{m(!0);try{const _=(await Qc(i.word)).slice(7,-5),E=JSON.parse(_);m(!1),c(E)}catch(S){console.log(S)}})()},[]),k.jsxs(k.Fragment,{children:[f&&k.jsx("div",{className:"p-5 absolute flex justify-center items-center z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-screen h-screen ",children:k.jsx(Zc,{variant:"track-disc",color:"#000",size:"large",text:"Loading..",textColor:""})}),l&&k.jsxs(k.Fragment,{children:[k.jsx("div",{className:" fixed w-screen z-30 h-screen top-0 left-0 bg-[rgba(0,0,0,0.7)]"}),k.jsxs("div",{className:"bg-white p-5 fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] md:w-[60vw] rounded-lg",children:[k.jsx("button",{className:"absolute top-2 right-2",onClick:()=>s(),children:k.jsx(Hr,{className:"w-10 h-10 text-red-600 hover:text-red-700"})}),k.jsxs("div",{className:"flex flex-col gap-2 py-2 px-4 w-full h-full overflow-auto ",children:[k.jsx("h1",{className:"font-bold text-xl",children:"Traduccion"}),k.jsx("p",{className:" text-lg font-bold text-blue-900",children:l.translate}),k.jsx("h2",{className:"font-bold text-lg",children:"Ejemplos:"}),k.jsx("div",{className:"px-4",children:k.jsx(k.Fragment,{children:l.examples.map((b,S)=>k.jsxs("div",{className:"text-lg text-blue-900",children:[k.jsx("p",{className:"font-bold",children:b.sentence}),k.jsx("p",{className:"text-gray-500",children:b.translation})]},S))})}),k.jsx("p",{className:"text-lg text-gray-500",children:l.usage})]})]})]})]})};function Sh(){const{words:i,showcard:s,showMoreDetails:l,warning:c,playMemory:f,showFormCard:m,setWarning:b,addClickWord:S,setShowFormCard:_,showDetailCard:E,setPlayMemory:R}=$r(),[I,j]=J.useState(!1),[M,C]=J.useState(""),[w,L]=J.useState(""),[Q,se]=J.useState(null),[ae,de]=J.useState(!1),[we,he]=J.useState(!1);J.useEffect(()=>{s&&j(!0)},[s]),J.useEffect(()=>{localStorage.setItem("words",JSON.stringify(i))},[i]),J.useEffect(()=>{c.boolean&&setTimeout(()=>{b("",!1)},2e3)},[c]);const ve=()=>{c.type==="addWrong"&&c.boolean,c.type=="play"&&c.boolean,c.type=="addSuccess"&&c.boolean,c.type=="delete"&&c.boolean,c.type=="successPlay"&&c.boolean,c.type=="search"&&c.boolean},ze=te=>{te.preventDefault(),C(te.target.value)},_e=i.filter(te=>te.word.toLowerCase().includes(M.toLowerCase())),mn=async te=>{if(te.preventDefault(),w===""){b("search",!0);return}de(!0);try{const Ge=(await Qc(w)).slice(7,-5),Re=JSON.parse(Ge);de(!1),se(Re),console.log(Re)}catch(Ce){console.log(Ce)}},zn=te=>{const Ce=te.word,Ge=te.translate,Re={word:Ce,translate:Ge};if(i.find(D=>D.word===Ce)){b("addWrong",!0);return}S(Re),b("addSuccess",!0)},sn=()=>{i.length>0?R():b("play",!0)};return k.jsxs(k.Fragment,{children:[f&&k.jsx(Sp,{}),l!==""&&k.jsx(kh,{}),ve(),m&&k.jsx(wp,{}),k.jsxs("div",{className:"flex justify-center px-4 py-4 md:px-8 md:p-0 flex-col md:flex-row items-center w-full h-full gap-4",children:[k.jsxs("div",{className:"md:flex-[1] w-full h-96 md:h-[90vh] bg-slate-100 rounded-xl flex p-6 flex-col justify-center items-center",children:[k.jsxs("h1",{className:"text-2xl text-center text-blue-800 mb-2",children:[" ","Palabras guardadas"]}),k.jsx("form",{onChange:ze,className:"w-full mb-5",children:k.jsx("input",{className:"p-2 w-full bg-white rounded-lg border border-blue-700",id:"name",name:"name",placeholder:"Buscar palabra",value:M})}),k.jsx("div",{className:"flex flex-col w-full h-full gap-2 overflow-auto",children:_e.map((te,Ce)=>k.jsx("button",{className:"bg-white hover:bg-gray-100 transition-all shadow-lg rounded-xl p-4 text-lg text-center text-blue-600",onClick:()=>E(te.word,te.translate),children:te.word},Ce))})]}),k.jsxs("div",{className:"flex-[3] w-full flex flex-col h-full md:h-[90vh] gap-2",children:[k.jsxs("div",{className:"flex flex-col  md:flex-row w-full h-2/5 justify-center items-center gap-2",children:[k.jsx("div",{className:"w-full md:w-1/2 h-full",children:s&&k.jsx("div",{className:`transition-transform  transform duration-300 ease-out ${I?"scale-100":"scale-0"} w-full h-full flex flex-col justify-between p-4 gap-4  bg-slate-100 rounded-xl shadow-md`,children:k.jsx(kp,{})})}),k.jsxs("div",{className:"w-full md:w-1/2 h-full flex flex-col gap-2",children:[k.jsxs("button",{onClick:()=>sn(),className:"bg-green-500 w-full h-1/2 hover:bg-green-600 text-white font-bold px-6 py-4 rounded-xl flex justify-center items-center gap-2",children:[k.jsx(up,{height:40,width:40}),"Recordar"]}),k.jsxs("button",{className:"bg-blue-600 w-full h-1/2 hover:bg-blue-700 text-white font-bold px-6 py-4 rounded-xl  flex justify-center items-center gap-2",onClick:()=>_(),children:[k.jsx(dp,{height:40,width:40,className:"hover:animate-spin"})," ","Añadir palabras"]})]})]}),k.jsxs("div",{className:`flex flex-col w-full h-3/5 ${Q?"bg-white":"bg-transparent"} ${Q?"rounded-xl":"rounded-none"}`,children:[k.jsxs("div",{className:"relative w-full md:flex-[1] h-16",children:[k.jsx("button",{onClick:()=>he(!0),className:`absolute z-30 w-full md:w-1/2 right-0 bg-blue-700 hover:bg-blue-800 text-white p-4 rounded-xl transition-all duration-500 ease-in-out ${we?"opacity-0 pointer-events-none":"opacity-100"}`,children:"Buscar palabras por IA"}),k.jsxs("form",{className:`absolute z-20 w-full right-0 flex gap-2 items-center bg-white p-2 rounded-xl transition-all duration-500 ease-in-out ${we?"translate-x-0 opacity-100":"translate-x-full opacity-0"}`,onSubmit:mn,children:[k.jsx("label",{className:"text-blue-700 font-bold",children:"Buscar:"}),k.jsx("input",{className:"p-2 w-full text-lg bg-white rounded-lg border border-blue-900",placeholder:"Buscar traducción de palabra ingles o español",type:"text",name:"search",id:"search",value:w,onChange:te=>L(te.target.value)}),k.jsx("button",{className:"bg-blue-600 hover:bg-blue-700 text-white font-bold p-3 rounded-lg",type:"submit",children:"Buscar"})]})]}),k.jsxs("div",{className:`flex-[4.8] relative flex flex-col ${Q?"bg-white":"bg-transparent"}  rounded-xl overflow-auto`,children:[ae&&k.jsx("div",{className:"h-full w-full absolute top-0 left-0 flex justify-center items-center",children:k.jsx(Zc,{variant:"track-disc",color:"#000",size:"large",text:"Loading..",textColor:""})}),Q&&k.jsxs(k.Fragment,{children:[k.jsx("button",{className:"absolute top-2 right-2 z-[25] py-2 px-4 text-white bg-blue-900 hover:bg-blue-800 rounded-lg",onClick:()=>zn(Q),children:"Añadir palabra"}),k.jsxs("div",{className:"flex flex-col gap-2 py-2 px-4 w-full h-full overflow-auto ",children:[k.jsx("div",{className:"bg-orange-500 w-32 p-0.5 text-white rounded-full ",children:k.jsx("p",{className:"text-lg text-center",children:"Traducción:"})}),k.jsx("p",{className:" text-lg font-bold ml-2 text-blue-900",children:Q.translate}),k.jsx("h2",{className:"font-bold ml-1 text-lg",children:"Ejemplos:"}),k.jsx("div",{className:"mx-6",children:k.jsx(k.Fragment,{children:Q.examples.map((te,Ce)=>k.jsxs("div",{className:"text-lg text-blue-900",children:[k.jsx("p",{className:"font-bold",children:te.sentence}),k.jsx("p",{className:"text-gray-500",children:te.translation})]},Ce))})}),k.jsx("p",{className:"text-lg text-gray-500",children:Q.usage})]})]})]})]})]})]})]})}ip.createRoot(document.getElementById("root")).render(k.jsx(J.StrictMode,{children:k.jsx(Sh,{})}));
